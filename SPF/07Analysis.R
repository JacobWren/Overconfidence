...
# 
# # INDIVIDUAL
# results_individual <- fn_analyze_model(data_idvl)
# 
# cat("\n\n")
...
# results_aggregate <- fn_analyze_model(data_agg, cluster_by_event_only=TRUE)
# 
...
ggsave("Graphs/calibration.pdf", plot = my_plot, device = "pdf", width = 10, height = 6)
